...
Briefly describe what will be included in the section: Explanation of
the datasets included in the catalog, the building of the catalog
(s11-cats)

\subsection{Datasets included}\label{datasets-included}

\subsection{S11-cats repository}\label{s11-cats-repository}

Description of modules

\subsubsection{Proposed Catalog
...
presented and a hierachical structure of

and definition of subcatalogs and/or collections to group items with
similar metadata. Initially, the creation of two different subcatalogs
is proposed to keep the static and dynamic dataset separated. Moreover,
the selection of the \href{https://stac-extensions.github.io/}{STAC
extensions}\footnote{STAC extensions are additional metadata properties
  that can be added to a dataset. (e.g.~Classes, bands, sensor-type,
  etc.)} used for each dataset will be defined in this step.
