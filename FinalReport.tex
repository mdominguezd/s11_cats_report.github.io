...
queried. On the other hand, dynamic catalogs are generated as HTTP-
based APIs ({[}STAC
API{]}(\url{https://github.com/radiantearth/stac-api-spec/})) that
respond to queries dynamically. More specifically, these catalogs will
show different views of the same catalog depending on queries that
usually focus on the spatio-temporal aspect of the data
(\citeproc{ref-noauthor_stac-specbest-practicesmd_nodate}{\emph{Stac-Spec/Best-Practices.md
at Master · Radiantearth/Stac-Spec}, n.d.}).
...
\emph{Stac-spec/best-practices.md at master · radiantearth/stac-spec.
{GitHub}}. (n.d.). Retrieved July 22, 2024, from
