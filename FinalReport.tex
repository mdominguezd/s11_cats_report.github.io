...
\hl{Add info about how most of their work, if not all is cloud based. (DSHUB, DPROF, Google)}
...
tiles are requested 1.74 times faster than the same file in ZARR format.
...
decreased by a factor of -0.009 and 0.007 per zoom level for COGs and
ZARRs respectively.
