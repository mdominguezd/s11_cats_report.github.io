...
K8s had been already assessed by previous studies. \ldots{}

Additional to the simplification that eoAPI provided to deploy this
using GKE and the Helm chart, we also went for that option because it
had already been tested by other authors using large datasets and heavy
load requests (\citeproc{ref-munteanu_performance_2024}{Munteanu et al.,
2024}). Munteanu et al. (\citeproc{ref-munteanu_performance_2024}{2024})
perform tests with 2.3 TB of spatial data stored in S3 and a simulated
