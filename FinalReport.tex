...
Furthermore, beased on the answers of the interviewees a workflow was
...
Finally, the answers to the questionnaire were analysed qualitatively
following a Thematic Context Analysis (TCA). This type of qualitative
...
large language model (i.e.~Chat-GPT 3.5) using the prompt presented on
Section~\ref{sec-gpt-prompt}. Moreover, the themes identified were
further refined based on the interviewer's interpretation.
...
presented and a hierachical structure composed of thematic collections
