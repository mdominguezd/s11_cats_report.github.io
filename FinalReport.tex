...
applications (\citeproc{ref-poulton_kubernetes_2023}{Poulton, 2023}). It
...
decreased by a factor of -0.01 and 0.002 per zoom level for COGs and
ZARRs respectively.
...
\NormalTok{        url\_zarr }\OperatorTok{=} \StringTok{"http://localhost:8080/tiles/WebMercatorQuad/"}\OperatorTok{+\textbackslash{}}
