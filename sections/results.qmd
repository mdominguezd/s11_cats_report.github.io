...
data.to_csv('request_time_results_2iter.csv')
```
...
data = pd.read_csv('https://raw.githubusercontent.com/mdominguezd/s11_cats_report.github.io/main/sections/request_time_results_2iter.csv')
