...
::: {layout-ncol="1" style="font-size: 75%;"}
-   High dependency on colleagues for dataset location.
-   **Disorganized structure**[^2] of Google Storage Buckets.
-   Data familiarity helps users locate data more quickly.
-   Locating data is dependent on recurrent work with a specific dataset.
...
[^2]: Similarly @miranda_espinosa_reviewing_2020 proposed that the main challenges are: "Different query interfaces and diverse metadata models".
...
![](https://yegvet.ca/wp-content/uploads/2024/02/Scared-Cats-What-to-Know-and-What-to-Do.webp){.fragment fig-align="center" width="50%"}
