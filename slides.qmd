...
- Traditional SDI focus: [preservation > accesibility]{.box}. [@durbha_advances_2023]
...
- Made the catalog queryable (Dynamic).
...
-   High dependency on colleagues for dataset location.
-   **Disorganized structure**[^1] of Google Storage Buckets.
-   Data familiarity helps users locate data more quickly.
-   Locating data is dependent on recurrent work with a specific dataset.
...
[^1]: Similarly @miranda_espinosa_reviewing_2020 proposed that the main challenges are: "Different query interfaces and diverse metadata models makes it difficult to acces the data".
...
Datasets selected $\rightarrow$ [S11-cats]{.box} $\rightarrow$ Static catalog
:::
...
![](https://yegvet.ca/wp-content/uploads/2024/02/Scared-Cats-What-to-Know-and-What-to-Do.webp){.fragment fig-align='center' width="60%"}
...
<iframe src="https://eoapi.dev" style="height:75%;width:100%;"  title="eoAPI"></iframe>
...
- We developed a methodology to effectively do the integration of multiple data formats and services. (i.e. COGs, Zarrs, eoAPI, TiTilers, etc.)
...
### [3]{.circle} Comparison of visualization of different cloud-optimized formats {#sec-cog-zarr}
